...
// FAVORITES CORE API
//
// Device-local favorite system.
// Eyni API bütün layihədə istifadə olunur.
//
// Backenddə favorites cədvəli olmadığı üçün hazırda
// Supabase sxeminə toxunmuruq.
//
// Gələcəkdə cross-device sync lazım olsa,
// API dəyişmədən storage layer Supabase-ə keçirilə bilər.
// ============================================================
